...
>(({ className, ...props }, ref) => (
    <AlertDialogPortal>
        ...
        <AlertDialogPrimitive.Content
            ref={ref}
            className={cn(
                "fixed left-1/2 top-1/2 z-50 grid w-full max-w-xl -translate-x-1/2 -translate-y-1/2 gap-8 rounded-3xl border-2 border-pvbx-primary bg-pvbx-quaternary p-6 shadow-lg duration-200",
                {
...
>(({ className, ...props }, ref) => (
    <AlertDialogPrimitive.Title
        ref={ref}
        className={cn("text-2xl font-bold text-pvbx-primary", className)}
        {...props}
    />
))
...
>(({ className, ...props }, ref) => (
    <AlertDialogPrimitive.Description
        ref={ref}
        className={cn("text-pretty px-8 text-sm text-muted-foreground", className)}
        {...props}
    />
))
